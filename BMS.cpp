...
void mainBlock(){
	...
	cout.width(79);
	cout<< endl << " W_E_L_C_O_M_E_ _T_O_ _B_A_N_K_ _O_F_ _H_Y_D_E_R_A_B_A_D_ [B.O.H]"<< endl;
...
void openAcc(){
	...
	do{
	cout<< "Please set a security pin: "; cin>>pin1; 
	cout<<endl<< "Confirm security pin: "; cin>>pin2; 
	...
	Sleep(3000);
	cout<< endl << "Thanks for choosing Bank of Hyderabad "<<name<<" , your new account is ready to use!"<< endl;
	Sleep(2000);
}
